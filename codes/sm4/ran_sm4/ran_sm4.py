...
logging.basicConfig(level=logging.DEBUG,
                    filename='./log-20191206-SM4(CBC)-crypt-' + '-' + '.log',
                    filemode='a+',
...
def encrypt(data):
    demo = newest_sm4.SM4(key='404142434445464748494A4B4C4D4E4F')
    res = demo.sm4_encrypt(common.message_padding(data, common.SM4_PAD_UNION), newest_sm4.SM4_CBC)
    return res

def decrypt(data):
    demo = newest_sm4.SM4(key='404142434445464748494A4B4C4D4E4F')
    res = demo.sm4_decrypt(data,newest_sm4.SM4_CBC)
    return res
...
for i in range(1000):
    ...
    func2 = decrypt
    # def ms_time_count(func1, func2, alg, mode, data, key, n):
    ms_time_count(func1,func2 ,alg='SM4',mode='SM4.MODE_CBC',data=test_data,key='404142434445464748494A4B4C4D4E4F',n=i)
