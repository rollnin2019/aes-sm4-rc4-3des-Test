...
logging.basicConfig(level=logging.DEBUG,
                    filename='./log-20191206-3DES(CBC)-crypt-' + '-' + '.log',
                    filemode='a+',
...
def encrypt(data):
    ...
    demo = DES3.new(binascii.unhexlify("404142434445464748494A4B4C4D4E4F"),mode=DES3.MODE_CBC,iv=iv)
...
for i in range(1000):
    ...
    func2 = decrypt
    # def ms_time_count(func1, func2, alg, mode, data, key, n):
    ms_time_count(func1,func2 ,alg='3DES',mode='3DES.MODE_CBC',data=test_data,key='404142434445464748494A4B4C4D4E4F',n=i)
